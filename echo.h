...
*/
void echo_on_game_chat_or_action(AMX*, int t, int playerid, char *text);
/**
...
*/
void echo_on_player_connection(AMX*, int playerid, int reason);
/**
Handle received UDP packet.
Call from onUDPReceiveData
*/
void echo_on_receive(AMX*, cell socket, cell data_a, char *data, int len);