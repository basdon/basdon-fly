...
void game_sa_init()
{
	...
	vehicleflags[MODEL_RUSTLER - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR;
	...
	vehicleflags[MODEL_STUNT - VEHICLE_MODEL_MIN] = PLANE;
	vehicleflags[MODEL_SHAMAL - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR;
	vehicleflags[MODEL_HYDRA - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR;
	vehicleflags[MODEL_CARGOBOB - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_NEVADA - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR;
