...
void game_sa_init()
{
	...
	vehicleflags[MODEL_LEVIATHN - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_HUNTER - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_SEASPAR - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_SKIMMER - VEHICLE_MODEL_MIN] = PLANE;
	vehicleflags[MODEL_RCBARON - VEHICLE_MODEL_MIN] = PLANE;
	vehicleflags[MODEL_RCRAIDER - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_SPARROW - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_RUSTLER - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR | NEEDS_GHOST_DOOR_FIX;
	vehicleflags[MODEL_MAVERICK - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_VCNMAV - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_POLMAV - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_RCGOBLIN - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_BEAGLE - VEHICLE_MODEL_MIN] = PLANE;
	vehicleflags[MODEL_CROPDUST - VEHICLE_MODEL_MIN] = PLANE;
	vehicleflags[MODEL_STUNT - VEHICLE_MODEL_MIN] = PLANE | NEEDS_GHOST_DOOR_FIX;
	vehicleflags[MODEL_SHAMAL - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR | NEEDS_GHOST_DOOR_FIX;
	vehicleflags[MODEL_HYDRA - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR | NEEDS_GHOST_DOOR_FIX;
	vehicleflags[MODEL_CARGOBOB - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_NEVADA - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR | NEEDS_GHOST_DOOR_FIX;
	vehicleflags[MODEL_RAINDANC - VEHICLE_MODEL_MIN] = HELI;
	vehicleflags[MODEL_AT400 - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR;
	vehicleflags[MODEL_ANDROM - VEHICLE_MODEL_MIN] = PLANE | RETRACTABLE_GEAR;
	vehicleflags[MODEL_DODO - VEHICLE_MODEL_MIN] = PLANE;
