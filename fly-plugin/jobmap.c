...
STATIC_ASSERT(NUM_MISSIONMAP_LOCATIONS_TEXTDRAWS == 10);
...
#if NUM_MISSIONMAP_LOCATIONS_TEXTDRAWS - 1 != 9
#error
#endif
	/*Showing all but "to" textdraws.*/
	textdraws_show(playerid, 9,
		...
		&td_jobmap_island_strs, &td_jobmap_island_wmre,
		&td_jobmap_from);
