...
static struct COMMAND cmds[] = {
#ifdef DEV
	{ 0, "/*m", GROUPS_ALL, "<amount>", cmd_dev_STARm },
	{ 0, "/cp", GROUPS_ALL, "", cmd_dev_cp },
	{ 0, "/crashme", GROUPS_ALL, "", cmd_dev_crashme },
	{ 0, "/drvc", GROUPS_ALL, "<disable:1/0>", cmd_dev_disableremotevehiclecollisions },
	{ 0, "/fweather", GROUPS_ALL, "<weatherid>", timecyc_cmd_dev_fweather },
	{ 0, "/gt", GROUPS_ALL, "<style> <text>", cmd_dev_gt },
	{ 0, "/jetpack", GROUPS_ALL, "", cmd_dev_jetpack },
	{ 0, "/kickme", GROUPS_ALL, "", cmd_dev_kickme },
	{ 0, "/kill", GROUPS_ALL, "", cmd_dev_kill },
	{ 0, "/nweather", GROUPS_ALL, "<weatherid>", timecyc_cmd_dev_nweather },
	{ 0, "/owner", GROUPS_ALL, "", cmd_dev_owner },
	{ 0, "/platform", GROUPS_ALL, "", cmd_dev_platform },
	{ 0, "/sound", GROUPS_ALL, "<soundid>", cmd_dev_sound },
	...
	{ 0, "/timex", GROUPS_ALL, "<h> <m>", cmd_dev_timex },
	{ 0, "/tweather", GROUPS_ALL, "<weatherid>", timecyc_cmd_dev_tweather },
	{ 0, "/v", GROUPS_ALL, "<modelid|modelname>", cmd_dev_v },
...
#endif /*DEV*/
	{ 0, "//getcar", GROUPS_ADMIN, "<vehicleid>", cmd_admin_getcar },
	{ 0, "//goto", GROUPS_ADMIN, "(<x> <y> <z>|<airport code/playerid/name>)", cmd_admin_goto },
	{ 0, "//gotorel", GROUPS_ADMIN, "[x] [y] [z]", cmd_admin_gotorel },
	{ 0, "//makeanewpermanentpublicvehiclehere", GROUP_OWNER, "<modelid|modelname>",
		cmd_admin_makeanewpermanentpublicvehiclehere },
	{ 0, "//respawn", GROUPS_ADMIN, "", cmd_admin_respawn },
	{ 0, "//rr", GROUPS_ADMIN, "", cmd_admin_rr },
	{ 0, "//streamdistance", GROUP_OWNER, "[distance]", cmd_admin_streamdistance },
	{ 0, "//tocar", GROUPS_ADMIN, "<vehicleid/modelname> [seat] [jack:1/0]", cmd_admin_tocar },
	{ 0, "//tomsp", GROUPS_ADMIN, "", cmd_admin_tomsp },
	{ 0, "//vehinfo", GROUP_OWNER, "", cmd_admin_vehinfo },
	{ 0, "/adf", GROUPS_ALL, "<beacon> - see /beacons or /nearest", nav_cmd_adf },
	{ 0, "/androm", GROUPS_ALL, "", cmd_androm },
	{ 0, "/andromada", GROUPS_ALL, "",cmd_androm },
	...
	{ 0, "/changelog", GROUPS_ALL, "", cmd_changelog },
	...
	{ 0, "/loc", GROUPS_ALL, "<playerid/(partial)name>", zones_cmd_loc },
	{ 0, "/nearest", GROUPS_ALL, "", airport_cmd_nearest },
	{ 0, "/m", GROUPS_ALL, "", missions_cmd_mission },
	{ 0, "/me", GROUPS_ALL, "<actiontext>", cmd_me },
	...
	{ 0, "/updates", GROUPS_ALL, "", cmd_changelog },
	{ 0, "/spray", GROUPS_ALL, "[primary] [secondary]", cmd_spray },
	{ 0, "/vor", GROUPS_ALL, "<beacon><runway> - see /beacons or /nearest", nav_cmd_vor },
