<div>
	<header>
		...
		<p><a href="index.php">Home</a> <!--:: <a href="news.php">News</a>--> :: <a href="flights.php">Flights</a> <!--:: <a href="map.php">Live Map</a>--> :: <a href="locations.php">Locations</a> :: <a href="article.php">Articles</a> :: <a href="trac.php">Tracker</a> <!--:: <a href="bbs.php">Message Board</a>--> :: <a href="stats.php">Stats</a></p>
	</header>
</div>
