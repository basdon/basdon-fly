...
build: out/basdonfly.o out/various.o out/panel.o out/amxplugin.o out/game_sa.o out/login.o out/commands.o out/dialog.o out/airport.o
	$(GCC) $(FLAGS) -shared -o out/basdonfly.$(PLUGINTYPE) out/basdonfly.o out/amxplugin.o out/various.o out/panel.o out/game_sa.o out/login.o out/commands.o out/dialog.o out/airport.o
