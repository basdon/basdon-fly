...
/*This file is directly included in zones.c,
so check for the IN_ZONES macro to only compile
this when we're inside zones.c*/
#ifdef IN_ZONES
...
{ -2994.49f, -430.276f, 0.0 -2831.89f, -222.589f, 200.0f, ZONE_OCEAF },
{ -2270.04f, -430.276f, 0.0 -2178.69f, -324.114f, 200.0f, ZONE_SILLY },
{ -2178.69f, -599.884f, 0.0 -1794.92f, -324.114f, 200.0f, ZONE_SILLY },
...
{ -2270.04f, -324.114f, 0.0 -1794.92f, -222.589f, 200.0f, ZONE_DOH },
