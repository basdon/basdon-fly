<footer>
	<div>
		...
		<small>
			{@unsafe date('j M Y H:i O')} - {@unsafe round(microtime(true) - $__timer, 6)}s {@unsafe $db_querycount}q<br/>
			<a href="credits.php">credits</a> :: <a href="contact.php">contact</a> :: <a href="brand.php">brand</a> :: <a href="https://github.com/basdon">github</a>{@globe}
		</small>
		<div class="clear"></div>
	</div>
</footer>
