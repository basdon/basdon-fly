...
<body>
	...
	<main class=center>
		...
		<p>
			<a href=https://dump.robin.basdon.net/sa-mp-0.3.7-R5-1-install.exe>SA-MP 0.3.7</a> or 0.3.DL - <a href="article.php?title=How_To_Join">How to join</a>
		</p>
		<p>
		...
		<p><img style=width:980px src=/s/gen/playergraph.png alt="player count graph of last 24 hours of activity"></p>
