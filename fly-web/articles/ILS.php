<p>
	...
	onto a runway. Unlike <?php link_article('VOR'); ?>, ILS offers both horizontal
...
<pre>/ils</pre>
<p>
	ILS will only work when <?php link_article('VOR'); ?> is already engaged.
...
<figure>
	<img class=fullsize src=/s/articles/ils.png alt="a dodo heading for a runway ahead, on the screen there are 9 Xs next to each other and 9 Xs above each other, both series having the middle X in common." title="ILS indicator">
	<figcaption>ILS hud</figcaption>
</figure>
<p>
...
<figure>
	<img class=fullsize src=/s/articles/ilsno.png alt="red text showing 'NO ILS SIGNAL'" title="no ILS signal">
	<figcaption>Out of ILS range</figcaption>
</figure>
...
<figure>
	<img class=fullsize src=/s/articles/ils1.png alt="a top and side view of aircraft going towards a runway, with the ILS indicator at the right" title="ILS example 1">
	<figcaption>ILS example 1</figcaption>
</figure>
<p>
...
<figure>
	<img class=fullsize src=/s/articles/ils2.png alt="a top and side view of aircraft going towards a runway, with the ILS indicator at the right" title="ILS example 2">
	<figcaption>ILS example 2</figcaption>
</figure>
<p>
...
<figure>
	<img class=fullsize src=/s/articles/ils3.png alt="a top and side view of aircraft going towards a runway, with the ILS indicator at the right" title="ILS example 3">
	<figcaption>ILS example 3</figcaption>
</figure>
<p>
	When the aircraft is completely out of range of the ILS signal, either
	horizontally or vertically, the indicator will hide and a <em>No ILS signal</em>
	text will appear.
<figure>
	<img class=fullsize src=/s/articles/ils4.png alt="a top and side view of aircraft going towards a runway, with the ILS indicator at the right" title="ILS example 4">
	<figcaption>ILS example 4</figcaption>
</figure>
