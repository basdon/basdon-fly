<p>
	...
	<?php link_article('Flight_file_format', '', true) ?>Flight</a> files.
	This service is implemented as an
	<a href=https://github.com/yugecin/anna>Anna^</a><img src=/s/moin-www.png alt="globe icon" title="external link">
	mod.
<p>
	Flighttracker listens on port <code>7766</code>.
...
<h4 id=p1>Packet type 1: new mission</h4>
...
<p>
	See <?php link_article('Flight_file_format'); ?> for flag values.

<h4 id=p2>Packet type 2: mission flight data</h4>
...
<pre>bit 1: is player paused
bit 2: is engine on
bit 3: is first packet since flight was paused
</pre>

<h4 id=p3>Packet type 3: mission end</h4>
...
<h4 id=p4>Packet type 4: server started</h4>
...
<h4 id=p5>Packet type 5: mission end</h4>
...
<ul>
	<li><?php link_article('Flight_file_format'); ?>
</ul>
